...
public class EqualityTester {
    ...
    public EqualityTester assertEqualTo(Object o2) {
        validateReflexiveEquality(o1);
        validateReflexiveEquality(o2);
        ...
        if (!Objects.deepEquals(o2, o1)) {
            throw new AssertionError(MessageFormat.format("Equality is expected to be symmetrical, but while {0} is equal to {1}, {1} is not equal to {0}", o1, o2));
        }
    ...
    public EqualityTester assertNotEqualTo(Object o2) {
        ...
        if (Objects.deepEquals(o2, o1)) {
            throw new AssertionError(MessageFormat.format("Equality is expected to be symmetrical, but while {0} is not equal to {1}, {1} is equal to {0}", o1, o2));
        }
        return this;
    }

    private void validateReflexiveEquality(Object o) throws AssertionError {
        if (!Objects.deepEquals(o, o)) {
            throw new AssertionError(MessageFormat.format("Equality is expected to be reflexive, but {0} is not equal to itself!", o));
        }
    }
